...
class SacdAgent(BaseAgent):
    ...
    def __init__(self, env, test_env, log_dir, num_steps=100000, batch_size=64, d_model=128, 
                actor_lr=0.0001, critic_lr=0.001, memory_size=1000000, gamma=0.99, multi_step=1,
        ...
        self.policy = CateoricalPolicy(
            d_model, self.env.observation_space.shape[0], self.env.action_space.n
            ).to(self.device)
